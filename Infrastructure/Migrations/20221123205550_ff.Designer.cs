...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.BasketItem", b =>
                {
                    ...
                    b.HasKey("ProductId", "CustomerBasketId");
            ...
            modelBuilder.Entity("Core.Entities.BrandOfProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("BrandOfProduct");
                });

            modelBuilder.Entity("Core.Entities.CategoryOfProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.Product", b =>
                {
                    ...
                    b.Property<int>("BrandOfProductId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.AppUserAddress", b =>
                {
                    b.HasOne("Core.Entities.AppUser", "AppUser")
                        ...
                        .HasForeignKey("Core.Entities.AppUserAddress", "AppUserId")
            ...
            modelBuilder.Entity("Core.Entities.CustomerBasket", b =>
                {
                    b.HasOne("Core.Entities.AppUser", "AppUser")
                        ...
                        .HasForeignKey("Core.Entities.CustomerBasket", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Core.Entities.Order", b =>
                {
                    ...
                    b.OwnsOne("Core.OrderAddress", "ShipToAddress", b1 =>
                        {
            ...
            modelBuilder.Entity("Core.Entities.Product", b =>
                {
                    b.HasOne("Core.Entities.BrandOfProduct", "BrandOfProduct")
                        .WithMany("Products")
                        .HasForeignKey("BrandOfProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Entities.CategoryOfProduct", "CategoryOfProduct")
                        .WithMany("Products")
